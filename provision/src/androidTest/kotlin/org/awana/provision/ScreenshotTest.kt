...
class ScreenshotTest {
     ...
     * this test standing in for the enrolling phones by fetching what they
    ...
    private fun report(id: String, ok: Boolean, make: String, model: String) = EnrolmentReport(
        deviceId = id,
    ...
    private fun post(report: EnrolmentReport) {
