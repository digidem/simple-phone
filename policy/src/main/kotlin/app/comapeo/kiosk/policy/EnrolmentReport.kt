...
/**
 * What a device tells the provisioning app when it finishes enrolling. This is
...
data class EnrolmentReport(
    ...
    val permissionFailures: List<String>,
    ...
    fun encode(): String = KioskConfig.json.encodeToString(serializer(), this)

    companion object {
        fun parse(text: String): EnrolmentReport =
            KioskConfig.json.decodeFromString(serializer(), text)
    }
}
